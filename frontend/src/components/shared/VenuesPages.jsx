...
export function VenuesPage({ onNavigateBack }) {
  ...
  // Read event type from URL on mount
  useEffect(() => {
    const eventTypeFromUrl = searchParams.get('type');
    if (eventTypeFromUrl) {
      setSelectedEventType(eventTypeFromUrl);
    }
  }, [searchParams]);
  ...
  }, [searchTerm, selectedEventType, selectedCapacity]);
        ...
        <div className="filters-container">
          ...
          <div className="filter-group">
            ...
            >
              ...
              <option value="500-1000 guests">500-1000 guests</option>
            </select>
          </div>
        </div>
      </section>
