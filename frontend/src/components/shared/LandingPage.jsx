...
export function LandingPage({ onNavigateToLogin, onNavigateToSignUp, onNavigateToVenues, onNavigateToAbout, onNavigateToTerms, onNavigateToOwnerSignup }) {
          ...
          <div className="host-card">
            <div className="host-content">
              ...
              <p className="host-description">
                Join our network of premium banquet halls and start receiving bookings from verified customers today.
              </p>
              <button
          ...
          <div className="footer-grid">
            ...
            <div className="footer-column">
              ...
              <ul className="footer-links">
                <li>
                  <button className="footer-link-btn" onClick={() => navigate('/venues?type=Wedding')}>
                    Wedding Venues
                  </button>
                </li>
                <li>
                  <button className="footer-link-btn" onClick={() => navigate('/venues?type=Corporate Event')}>
                    Corporate Events
                  </button>
                </li>
                <li>
                  <button className="footer-link-btn" onClick={() => navigate('/venues?type=Party')}>
                    Birthday Parties
                  </button>
                </li>
                <li>
